...
call "../../vista/bin/vscript" ./scripts/prep_stage_slr55.py %CONFIGFILE%
...
REM call python ../../scripts/prep_smscg.py DCR2021CC
call python ../../scripts/postpro_dss.py timeseries/2040alt.dss "/////15MIN//" timeseries/2040alt.dss
endlocal
