...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    'Z:/test/notebook_dsm2plan/pydelmod_plan',
    'default_mod_dir':    'Z:/test/notebook_dsm2plan/pydelmod_plan\\Lib\\site-packages',
    'default_sip_dir':    'Z:/test/notebook_dsm2plan/pydelmod_plan\\sip',
    'deployment_target':  '',
    'platform':           'win32-msvc2015',
    'py_conf_inc_dir':    'Z:/test/notebook_dsm2plan/pydelmod_plan\\include',
    'py_inc_dir':         'Z:/test/notebook_dsm2plan/pydelmod_plan\\include',
    'py_lib_dir':         'Z:/test/notebook_dsm2plan/pydelmod_plan\\libs',
    'py_version':         0x030700,
    'qt_framework':       0,
    'sip_bin':            'Z:/test/notebook_dsm2plan/pydelmod_plan\\Library\\bin\\sip',
    'sip_config_args':    '--sysroot=Z:/test/notebook_dsm2plan/pydelmod_plan --bindir=Z:/test/notebook_dsm2plan/pydelmod_plan\\Library\\bin',
    'sip_inc_dir':        'Z:/test/notebook_dsm2plan/pydelmod_plan\\include',
    'sip_mod_dir':        'Z:/test/notebook_dsm2plan/pydelmod_plan\\Lib\\site-packages',
